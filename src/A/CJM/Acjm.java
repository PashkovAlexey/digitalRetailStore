...
import A.statistics.BusinessStatistics;
import A.another.Customer; import A.another.RetailStore; import A.it.BonusSystem;
import A.it.MobileApp; import A.product.Cheese; import A.product.Kefir; import A.retailStoreEquipment.DigitalPriceTag;
import A.writeReadDB.AllDBActions;

import java.util.ArrayList;
import java.util.List;

public abstract class Acjm {
    public static void aCJMStart() throws Exception {
